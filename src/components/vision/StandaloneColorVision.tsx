...
export const StandaloneColorVision = memo<{
  ...
  const handleVisionChange = useCallback((e: React.ChangeEvent<HTMLSelectElement>) => {
    setVisionType(e.target.value as ColorVisionType);
  }, []);
...
StandaloneColorVision.displayName = 'StandaloneColorVision';